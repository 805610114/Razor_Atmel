...
static void UserAppSM_ChannelOpen(void)          
{
  ...
  if( AntReadData() )
  {
    ...
    else if(G_eAntApiCurrentMessageClass == ANT_TICK)
    {
      ...
      /*Check the tick  message  contents*/
      if(u8LastState!=G_au8AntApiCurrentData[ANT_TICK_MSG_EVENT_CODE_INDEX])
      {
        ...
        au8TestMessage[6]=HexToASCIICharUpper(u8LastState);
        ...
        case EVENT_RX_FAIL:
          ...
          /*If we drop to search,LED green is on solid*/
...
/*Wait for ANT to close the channel*/
